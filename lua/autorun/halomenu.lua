...
if(CLIENT) then
spawnmenu.AddCreationTab( "Halo Vehicles", function()
	local ctrl = vgui.Create( "SpawnmenuContentPanel" )
    ctrl:CallPopulateHook( "HaloVehiclesTab" );
    return ctrl;
end, "iconshalo/halo.png", 60 )

spawnmenu.AddContentType( "halovehicle", function( container, obj )
    ...
    icon.DoClick = function()
        RunConsoleCommand( "halov_spawnsent", obj.spawnname );
...
spawnmenu.AddContentType( "haloweapon", function( container, obj )
	...
	icon.DoClick = function()
		...
		RunConsoleCommand( "halov_giveswep", obj.spawnname )
		surface.PlaySound( "ui/buttonclickrelease.wav" )
	...
	icon.DoMiddleClick = function()
		...
		RunConsoleCommand( "halov_spawnswep", obj.spawnname )
		surface.PlaySound( "ui/buttonclickrelease.wav" )
