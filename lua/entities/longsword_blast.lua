...
ENT.PrintName = "Longsword Nuke Bomb"
ENT.Author = "Liam0102"
ENT.Category = "Halo"
ENT.Spawnable = false;
...
if SERVER then
	...
	function ENT:Initialize()
		...
		self:SetColor(Color(255,160,0,1));
		
		self:SetNWBool("White",self.IsWhite);
		self:SetNWInt("StartSize",self.StartSize or 80);
		self:SetNWInt("EndSize",self.EndSize or 55);
